...
export default function App() {
  ...
  const horizontalHeader = (
    <div className="flex justify-between mt-5 mb-5 ml-24 mr-24 font-semibold text-gray-900 dark:text-gray-300">
  ...
  const jobsResults = () => {
    if (!jobs) {
      return <p className="text-center mt-10 mx-10 text-gray-900 dark:text-gray-300">Search the Adzuna job board using the search bar at the top.</p>;
    } else if (jobs.length === 0) {
      return <p className="text-center mt-10 mx-10 text-gray-900 dark:text-gray-300">No jobs were found matching the search criteria.</p>;
    }
