        ...
        <form className={`${grow ? "flex-grow" : "w-1/4"}`} onSubmit={handleSubmit}>
            <div className="flex">
                <div className="relative w-full">
                    <input type="search" id="search" className="block px-1 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border-s-2 
                  ...
                  dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                    ...
                    />
                    <button type="submit" className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-blue-500 rounded-e-lg border
